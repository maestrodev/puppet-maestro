...
class maestro::plugins(
  $plugins = {
    'maestro-ant-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
    'maestro-archive-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
    ...
    'maestro-git-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
    'maestro-gitblit-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
    'maestro-httputils-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
    'maestro-irc-plugin' => { version => '1.2' },
    'maestro-jenkins-plugin' => { version => '1.4.4' },
    'maestro-jira-plugin' => { version => '1.0' },
    'maestro-maven-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
    'maestro-puppet-plugin' => { version => '1.1' },
    'maestro-rake-plugin' => { version => '1.0', dir => 'com/maestrodev/maestro/plugins' },
